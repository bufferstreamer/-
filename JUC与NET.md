...
1**进程**：程序是静止的，程序实体的运行过程就是进程，是系统进行**资源分配的基本单位**
...
<img src="D:\笔记\JUC与NET.assets\JUC-两阶段终止模式.png" style="zoom: 67%;" />
...
![](D:\笔记\JUC与NET.assets\JUC-线程6种状态.png)
...
![](D:\笔记\JUC与NET.assets\JUC-锁升级过程.png)
...
<img src="D:\笔记\JUC与NET.assets\JUC-Monitor-MarkWord结构64位.png" style="zoom: 67%;" />
...
* 创建锁记录（Lock Record）对象，每个线程的**栈帧**都会包含一个锁记录的结构，存储锁定对象的 Mark Word
  ...
  ![](D:\笔记\JUC与NET.assets\JUC-轻量级锁原理1.png)

* 让锁记录中 Object reference 指向锁住的对象，并尝试用 CAS 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录
  

如果 CAS 替换成功，对象头中存储了锁记录地址和状态 00（轻量级锁） ，表示由该线程给对象加锁
![](D:\笔记\JUC与NET.assets\JUC-轻量级锁原理2.png)
...
* 如果 CAS 失败，有两种情况：
  ...
  * 如果是线程自己执行了 synchronized 锁重入，就添加一条 Lock Record 作为重入的计数
  ...
  ![](D:\笔记\JUC与NET.assets\JUC-轻量级锁原理3.png)
...
* 当 Thread-1 进行轻量级加锁时，Thread-0 已经对该对象加了轻量级锁
  ...
  ![](D:\笔记\JUC与NET.assets\JUC-重量级锁原理1.png)

* Thread-1 加轻量级锁失败，进入锁膨胀流程：为 Object 对象申请 Monitor 锁，**通过 Object 对象头获取到持锁线程**，将 Monitor 的 Owner 置为 Thread-0，将 Object 的对象头指向重量级锁地址，然后自己进入 Monitor 的 EntryList BLOCKED

  ![](D:\笔记\JUC与NET.assets\JUC-重量级锁原理2.png)
...
* 自旋成功的情况：
      <img src="D:\笔记\JUC与NET.assets\JUC-自旋成功.png" style="zoom: 80%;" />

* 自旋失败的情况：

  <img src="D:\笔记\JUC与NET.assets\JUC-自旋失败.png" style="zoom:80%;" />
...
![](D:\笔记\JUC与NET.assets\JUC-Monitor工作原理2-166849298289517.png)
...
![](D:\笔记\JUC与NET.assets\JUC-park原理1.png)
...
* 先 unpark：
  ...
  ![](D:\笔记\JUC与NET.assets\JUC-park原理2.png)
...
![](D:\笔记\JUC与NET.assets\JUC-保护性暂停.png)
...
![](D:\笔记\JUC与NET.assets\JUC-保护性暂停多任务版.png)
...
![](D:\笔记\JUC与NET.assets\JUC-生产者消费者模式.png)
...
![](D:\笔记\JUC与NET.assets\JMM内存模型.png)

主内存和工作内存：

* 主内存：计算机的内存，也就是经常提到的 8G 的内存，16G 内存，存储所有共享变量的值
...
<img src="D:\笔记\JUC与NET.assets\JMM-内存交互.png" style="zoom: 67%;" />
