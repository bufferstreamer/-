...
![谷粒商城-微服务架构图](project.assets/%E8%B0%B7%E7%B2%92%E5%95%86%E5%9F%8E-%E5%BE%AE%E6%9C%8D%E5%8A%A1%E6%9E%B6%E6%9E%84%E5%9B%BE.jpg)

# 项目划分

![image-20230411000802464](project.assets/image-20230411000802464.png)

# 基础

[一些文档](D:\BaiduNetdiskDownload\Guli Mall\文档\三阶段大纲md\谷粒商城—分布式基础.md)
...
![image-20200430215649355](project.assets/image-20200430215649355.png)
...
![1588732021702](project.assets/1588732021702.png)

比较规范的做法是，新建一个vo文件夹，将每种不同的对象，按照它的功能进行了划分。在java中，涉及到了这几种类型

![1588732152646](project.assets/1588732152646.png)
...
![1588766303205](project.assets/1588766303205.png)
...
![1588780868214](project.assets/1588780868214.png)
...
![1588822997675](project.assets/1588822997675.png)
...
在SPU中，写出的日期数据都不符合规则：
![image-20200509083248660](project.assets/image-20200509083248660.png)
...
![image-20200509170916557](project.assets/image-20200509170916557.png)
...
![image-20200509191108806](project.assets/image-20200509191108806.png)
...
![image-20200510182051355](project.assets/image-20200510182051355.png)
...
![image-20200510231012714](project.assets/image-20200510231012714.png)

这样当再次访问的时候，在“平台属性”下，会出现“规格维护”菜单，

![image-20200510231041708](project.assets/image-20200510231041708.png)

当再次点击“规格”的时候，显示出菜单

![image-20200510231200130](project.assets/image-20200510231200130.png)
...
![image-20200422221237751](project.assets/image-20200422221237751.png)



在Docker中设置开机启动容器

![image-20200423005200485](project.assets/image-20200423005200485.png)
...
![image-20200425165814903](project.assets/image-20200425165814903.png)

新建一个全局的代码片段，名字为vue，然后回车：

![image-20200425165929332](project.assets/image-20200425165929332.png)
...
查看elasticsearch 版本信息： http://192.168.6.128:9200/ 
...
![image-20200501192629304](project.assets/image-20200501192629304.png)
...
下面是在postman中的测试数据：
![image-20200501194449944](project.assets/image-20200501194449944.png)
...
<img src="project.assets/image-20200501195619925.png" alt="image-20200501195619925" style="zoom: 52%;" />

再次使用POST插入数据，仍然是新增的：

<img src="project.assets/image-20200501195732492.png" alt="image-20200501195732492" style="zoom: 80%;" />



添加数据的时候，指定ID，会使用该id，并且类型是新增：

<img src="project.assets/image-20200501200048361.png" alt="image-20200501200048361" style="zoom: 66%;" />

再次使用POST插入数据，类型为updated

<img src="project.assets/image-20200501200132199.png" alt="image-20200501200132199" style="zoom:67%;" />
...
<img src="project.assets/image-20200501212224983.png" alt="image-20200501212224983" style="zoom: 61%;" />

 （2）将name更新为2，更新过程中使用seq_no=6

http://192.168.6.128:9200/customer/external/1?if_seq_no=6&if_primary_term=1 

<img src="project.assets/image-20200501213047499.png" alt="image-20200501213047499" style="zoom: 60%;" />
...
![image-20200501212924094](project.assets/image-20200501212924094.png)
...
<img src="project.assets/image-20200501213130001.png" alt="image-20200501213130001" style="zoom:75%;" />

#### 更新文档

![image-20200501214522818](project.assets/image-20200501214522818.png)

 ![image-20200501215746139](project.assets/image-20200501215746139.png)

（1）POST更新文档，带有_update

http://192.168.6.128:9200/customer/external/1/_update 

![image-20200501214810741](project.assets/image-20200501214810741.png)

如果再次执行更新，则不执行任何操作，序列号也不发生变化

![image-20200501214912607](project.assets/image-20200501214912607.png)

POST更新方式，会对比原来的数据，和原来的相同，则不执行任何操作（version和_seq_no）都不变。

 （2）POST更新文档，不带_update

![image-20200501215358666](project.assets/image-20200501215358666.png)
...
<img src="project.assets/image-20200501220559094.png" alt="image-20200501220559094" style="zoom:67%;" />
...
![image-20200501221105476](project.assets/image-20200501221105476.png)
...
![image-20200501233938697](project.assets/image-20200501233938697.png)

![image-20200502000221422](project.assets/image-20200502000221422.png)

![image-20200502000733594](project.assets/image-20200502000733594.png)
...
![image-20200502120921830](project.assets/image-20200502120921830.png)
...
![image-20200502161339291](project.assets/image-20200502161339291.png)
...
![image-20200502170924399](project.assets/image-20200502170924399.png)
...
![image-20200502174825233](project.assets/image-20200502174825233.png)
...
![image-20200502175901959](project.assets/image-20200502175901959.png)
...
![image-20200502181432745](project.assets/image-20200502181432745.png)
...
![image-20200502182929583](project.assets/image-20200502182929583.png)
...
![image-20200511074437763](project.assets/image-20200511074437763.png)
...
![image-20200511111618183](project.assets/image-20200511111618183.png)

测试后：

![image-20200511112025327](project.assets/image-20200511112025327.png)
